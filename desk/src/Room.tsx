...
// Updated Props: Now accepts onFocus callback
...
// --- MAIN COMPONENT ---
export function Model({ animationName, targetName, onFocus, ...props }: ModelProps) {
  ...
  return (
    <group 
      ...
      onPointerEnter={(e) => {
        e.stopPropagation()
        if (e.object.name.includes('Plane0')) setHoveredName(e.object.name)
      }}
      onPointerLeave={(e) => {
        e.stopPropagation()
        setHoveredName(null)
      ...
      onClick={(e) => {
        ...
        if (e.object.name.includes('Plane0') && onFocus) {
             const targetPos = new THREE.Vector3()
